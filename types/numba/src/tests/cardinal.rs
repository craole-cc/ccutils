...
mod tests {
  ...
  fn test_numeric_to_worded() {
    ...
    assert_eq!(numeric_to_worded("one thousand").unwrap(), 1000.0);
    assert_eq!(numeric_to_worded("one million").unwrap(), 1_000_000.0);
    assert_eq!(numeric_to_worded("three billion").unwrap(), 3_000_000_000.0);
    ...
    assert_eq!(numeric_to_worded("two point zero one").unwrap(), 2.01);
    assert_eq!(numeric_to_worded("three point fourteen").unwrap(), 3.14);
    assert_eq!(numeric_to_worded("negative two point five").unwrap(), -2.5);
  ...
  fn test_worded_from_numeric() {
    ...
    assert_eq!(worded_from_numeric(2.01).unwrap(), "two point zero one");
