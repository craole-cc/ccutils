...
static WORD_VALUES: Lazy<HashMap<&'static str, u128>> = Lazy::new(|| {
  ...
  match value {
    ...
    21..=99 => {
      ...
      if ones == 0 {
        ...
        Ok(format!(
          "{}-{}",
          MEDIUM.get(tens as usize - 2).ok_or(Error::InvalidScale)?,
...
pub fn int_to_cardinal(&self, mut num: BigFloat) -> Result<String, Error> {
  // special case zero
  if num.is_zero() {
...
pub fn float_to_cardinal(&self, num: BigFloat) -> Result<String, Num2Err> {
