...
We welcome and appreciate all contributions to the **ccutils** project! Whether you're reporting a bug, suggesting an enhancement, improving documentation, or submitting code, your help is invaluable. By contributing, you agree to abide by our [Code of Conduct](./CODE_OF_CONDUCT).
...
3. **Initialize Jujutsu (jj):** If you prefer using `jj` for version control (as the core developers do), initialize `jj` within your cloned Git repository:
   ...
   _This command sets up `jj` to work alongside Git in the same repository. You can use either tool, but we encourage using `jj` for local development due to its powerful history editing and collaboration features._
...
- Before opening a new bug report, please check the [GitHub Issues page](https://github.com/craole-cc/ccutils/issues) to see if the issue has already been reported.
...
- Before suggesting a new feature, please check the [GitHub Issues page](https://github.com/craole-cc/ccutils/issues) and the [Roadmap](crates/wallter/ROADMAP.md) document to see if similar ideas are already being discussed or planned.
...
Refer to the [Roadmap](crates/wallter/ROADMAP.md) to find a suitable task or see where your proposed feature fits.

#### **Create a Changeset or Branch**

- **Using jj:** Create a new changeset for your work. This is similar to starting a new branch in Git, but with jj you work with changesets and bookmarks.
...
- **With jj:** Your changes are automatically tracked. To finalize your changeset and prepare for pushing, ensure your commit message is clear and complete:
...
- Open a pull request from your fork to the `main` branch of the `craole-cc/ccutils` repository.
...
Please note that all contributors are expected to adhere to our [Code of Conduct](./CODE_OF_CONDUCT).
